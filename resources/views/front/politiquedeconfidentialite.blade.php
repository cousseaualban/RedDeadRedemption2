...
<head>
    ...
    <!-- Styles -->
    @vite(['resources/sass/politiquedeconfidentialite.scss', 'resources/css/politiquedeconfidentialite.css'])
...
<body>
    ...
    <!-- Composant Header -->
    <x-header></x-header>
    <section class="politiqueDeConfidentialite">
        <h1>Politique de confidentialité</h1>

        <div class="contenu">
            <h2>Qui sommes-nous ?</h2>
            <p>L’adresse de notre site est : https://albancousseau-arinfo.fr<br>
                Commentaires<br>
                ...
                <br>Une chaîne anonymisée créée à partir de votre adresse e-mail (également appelée hash) peut être envoyée au service Gravatar pour vérifier si vous utilisez ce dernier. Les clauses de confidentialité du service Gravatar sont disponibles ici : https://automattic.com/privacy/. Après validation de votre commentaire, votre photo de profil sera visible publiquement à coté de votre commentaire.
            </p>
            <h2>Médias</h2>
